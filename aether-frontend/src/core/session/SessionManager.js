...
class SessionManager extends EventEmitter {
  ...
  getSession(chatId) {
    ...
    if (!this.sessions.has(chatId)) {
      ...
      sessionLogger.debug('session created', { chatId });
    }
  ...
  setActiveChat(chatId) {
    ...
    sessionLogger.trace('active session set', { chatId });
  }
  ...
  clearSession(chatId) {
    if (this.sessions.has(chatId)) {
      ...
      sessionLogger.debug('session cleared', { chatId });
    }
  ...
  clearAll() {
    ...
    sessionLogger.debug('all sessions cleared');
  }
...
if (typeof window !== 'undefined') {
  ...
  sessionLogger.debug('module loaded');
}
