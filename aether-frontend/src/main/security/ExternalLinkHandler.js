  ...
  createClickHandler() {
    return (event) => {
      try {
        ...
        logger.error('Click handler error', { error: err?.message });
      }
    };
  }
}
