...
const CHANNEL_CATEGORIES = freeze({
  ...
  'artifacts:stream:ready': 'high', // CRITICAL: Artifact streaming coordination requires high burst capacity
  'wheel-event': 'high',
  'widget-drag-move': 'high',
  'widget-drag-start': 'normal',
  'widget-drag-end': 'normal',
