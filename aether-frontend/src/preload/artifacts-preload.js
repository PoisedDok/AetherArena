 ...
 * Processing: Load libraries (highlight.js 21 languages, marked, DOMPurify), create secure IPC bridge with validation, freeze API objects, expose to renderer via contextBridge --- {4 jobs: JOB_ATTACH_TO_WINDOW, JOB_CREATE_BRIDGE, JOB_GET_STATE, JOB_INITIALIZE}
 * Outgoing: window.aether, window.hljs, window.marked, window.sanitizer (exposed to renderer) --- {preload_types.contextBridge_api, frozen_object}
 * 
