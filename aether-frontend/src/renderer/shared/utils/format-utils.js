...
const _fmtLog = (typeof require !== 'undefined')
  ? require('./logger').createRendererLogger('FormatUtils')
...
const FormatUtils = freeze({
  ...
  fileSize(bytes, decimals = CONFIG.DEFAULT_DECIMAL_PLACES) {
    try {
      ...
      _fmtLog.error('[FormatUtils] fileSize failed:', error);
      return '0 Bytes';
    }
  },
  ...
  number(num, decimals = 1) {
    try {
      ...
      _fmtLog.error('[FormatUtils] number failed:', error);
      return '0';
    }
  },
  ...
  numberWithSeparator(num, separator = ',') {
    try {
      ...
      _fmtLog.error('[FormatUtils] numberWithSeparator failed:', error);
      return String(num);
    }
  },
  ...
  percentage(value, decimals = 0, isDecimal = false) {
    try {
      ...
      _fmtLog.error('[FormatUtils] percentage failed:', error);
      return '0%';
    }
  },
  ...
  currency(amount, currency = 'USD', locale = undefined) {
    try {
      ...
      _fmtLog.error('[FormatUtils] currency failed:', error);
  ...
  truncate(text, maxLength, ellipsis = '...') {
    try {
      ...
      _fmtLog.error('[FormatUtils] truncate failed:', error);
      return text || '';
    }
  },
  ...
  truncateMiddle(text, maxLength, ellipsis = '...') {
    try {
      ...
      _fmtLog.error('[FormatUtils] truncateMiddle failed:', error);
      return text || '';
    }
  },
  ...
  pluralize(count, singular, plural = null) {
    try {
      ...
      _fmtLog.error('[FormatUtils] pluralize failed:', error);
      return singular;
    }
  },
  ...
  countWithWord(count, singular, plural = null) {
    try {
      ...
      _fmtLog.error('[FormatUtils] countWithWord failed:', error);
  ...
  phone(phone) {
    try {
      ...
      _fmtLog.error('[FormatUtils] phone failed:', error);
      return phone;
    }
  },
  ...
  json(data, indent = 2) {
    try {
      ...
      _fmtLog.error('[FormatUtils] json failed:', error);
      return String(data);
    }
  },
  ...
  latency(ms) {
    try {
      ...
      _fmtLog.error('[FormatUtils] latency failed:', error);
      return 'N/A';
    }
  },
  ...
  fps(fps) {
    try {
      ...
      _fmtLog.error('[FormatUtils] fps failed:', error);
      return '0 FPS';
    }
  },
  ...
  cpu(value) {
    try {
      ...
      _fmtLog.error('[FormatUtils] cpu failed:', error);
      return '0%';
    }
  },
  ...
  capitalize(str) {
    try {
      ...
      _fmtLog.error('[FormatUtils] capitalize failed:', error);
      return str;
    }
  },
  ...
  titleCase(str) {
    try {
      ...
      _fmtLog.error('[FormatUtils] titleCase failed:', error);
      return str;
    }
  },
  ...
  camelToKebab(str) {
    try {
      ...
      _fmtLog.error('[FormatUtils] camelToKebab failed:', error);
      return str;
    }
  },
  ...
  kebabToCamel(str) {
    try {
      ...
      _fmtLog.error('[FormatUtils] kebabToCamel failed:', error);
      return str;
    }
  },
  ...
  padNumber(num, length = 2) {
    try {
      ...
      _fmtLog.error('[FormatUtils] padNumber failed:', error);
      return String(num);
    }
  },
  ...
  list(items, conjunction = 'and') {
    try {
      ...
      _fmtLog.error('[FormatUtils] list failed:', error);
      return items.join(', ');
    }
  },
});
...
if (typeof window !== 'undefined') {
  ...
  _fmtLog.debug('📦 FormatUtils loaded');
}
