...
class Diagnostics {
  constructor() {
    this.log = createRendererLogger('Diagnostics');
    // State
    ...
    this.log.debug('[Diagnostics] Initialized (level:', this._getLevelName(this.logLevel), ')');
  }
  ...
  setLogLevel(level) {
    ...
    this.log.debug('[Diagnostics] Log level set to:', this._getLevelName(this.logLevel));
  }
