...
test.describe('Main Window', () => {
  ...
  test('should be able to toggle widget mode', async () => {
    // Find widget toggle button by id since we use ids instead of data-testid
    const toggleButton = await mainWindow.locator('#widget-mode-toggle, .widget-toggle').first();
  ...
  test('should have audio controls', async () => {
    // Check for handsfree/audio controls
    const audioButton = await mainWindow.locator('#handsfree-toggle, .audio-toggle').first();
  ...
  test('should open chat window', async () => {
    // Click chat button
    const chatButton = await mainWindow.locator('#chat-toggle').first();
  ...
  test('should open artifacts window', async () => {
    ...
    const artifactsButton = await mainWindow.locator('#code-panel-toggle, #artifacts-toggle').first();
