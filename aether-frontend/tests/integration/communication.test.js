...
function createMockResponse(options = {}) {
  ...
  // When json is provided but text is not, text() must return the serialized
  // JSON so that the text-first parsing path in ApiClient._fetch works.
  const textValue = text != null
    ? text
