...
describe('UI/UX Parity Validation', () => {
  ...
  describe('Chat Window Features', () => {
    ...
    test('should have message streaming support', () => {
      const messageOrchestrator = path.join(NEW_FRONTEND, 'src/renderer/chat/modules/messaging/MessageOrchestrator.js');
      expect(fs.existsSync(messageOrchestrator)).toBe(true);
      const content = fs.readFileSync(messageOrchestrator, 'utf8');
  ...
  describe('Artifacts Window Features', () => {
    ...
    test('should have code execution capability', () => {
      const artifactsService = path.join(NEW_FRONTEND, 'src/domain/artifacts/services/ArtifactExecutor.js');
