...
const entryPoints = [
  ...
  {
    name: 'notes-preload',
    in: join(srcDir, 'preload/notes-preload.js'),
    out: join(buildDir, 'notes-preload'),
  },
  {
    name: 'index-browser-preload',
    in: join(srcDir, 'preload/index-browser-preload.js'),
    out: join(buildDir, 'index-browser-preload'),
  },
  {
    name: 'research-preload',
    in: join(srcDir, 'preload/research-preload.js'),
    out: join(buildDir, 'research-preload'),
  },
];
