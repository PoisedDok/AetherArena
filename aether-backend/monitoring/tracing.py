...
@.architecture
Incoming: app.py, trace decorators, api/dependencies.py --- {str trace_id, Dict[str, Any] span_attrs}
Processing: manage span context, record distributed traces, export telemetry payloads --- {JOB_TRACE}
Outgoing: observability exporters, decorated functions --- {Span, Dict[str, Any] trace_json}
"""
