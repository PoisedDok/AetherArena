...
TESTS = [
    ...
    EndpointTest("GET", "/v1/models/capabilities", "Model capabilities",
                 query={"model": "lmstudio-community/Qwen3-4b-Instruct-2507-MLX-8bit"}),
    ...
    # Chat
    EndpointTest("POST", "/v1/create/chat", "Send chat message", 
                 payload={"message": "Hello"}, expected_status=200),
    EndpointTest("GET", "/v1/chat/history/default", "Get chat history", expected_status=200),
    
    # Storage  
    EndpointTest("GET", "/v1/storage", "List storage items", expected_status=200),
    EndpointTest("GET", "/v1/storage/stats", "Get storage stats", expected_status=200),
    ...
    # MCP
    EndpointTest("GET", "/v1/mcp/servers", "List MCP servers"),
    EndpointTest("GET", "/v1/mcp/health", "MCP system health"),
    EndpointTest("POST", "/v1/mcp/servers", "Register MCP server",
                 payload={
