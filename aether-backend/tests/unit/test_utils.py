...
from data.network.http_client import AetherHTTPClient, HTTPClientConfig
...
class TestHTTPClient:
    ...
    async def test_client_initialization(self):
        ...
        client = AetherHTTPClient(config=config)
...
class TestSettings:
    ...
    def test_settings_integration_config(self, test_settings):
        ...
        assert test_settings.integrations.docling_enabled is not None
