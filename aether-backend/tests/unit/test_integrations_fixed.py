...
class TestProviderIntegrations:
    ...
    def test_perplexica_available(self):
        ...
        try:
            from core.integrations.providers.perplexica import search as perplexica_search
            assert hasattr(perplexica_search, "perplexica_search")
        except ImportError as exc:
            pytest.fail(f"Perplexica not available: {exc}")
    
    def test_docling_available(self):
        """Test Docling integration is available."""
        try:
            from core.integrations.providers import docling as docling_provider
            assert hasattr(docling_provider, "DoclingService")
        except ImportError as exc:
            pytest.fail(f"Docling not available: {exc}")
    ...
    def test_xlwings_available(self):
        ...
        try:
            ...
            assert hasattr(xlwings_excel, "create_workbook")
        except ImportError as exc:
            pytest.fail(f"XLWings not available: {exc}")
