...
Processing: validate_all(), _validate_layer1(), _validate_layer2(), _validate_layer3(), _validate_layer4() --- {JOB_VALIDATE_SCHEMA}
...
class IntegrationValidator:
    ...
    def __init__(self, aether_backend_root: Optional[Path] = None):
        ...
        logger.info("IntegrationValidator initialized (aether-backend: %s)", self.aether_backend_root)
