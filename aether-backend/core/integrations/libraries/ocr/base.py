...
Processing: OCRBackend abstract methods, process_file(), process_image(), get_capabilities() --- {JOB_INITIALIZE_COMPONENT, JOB_TRANSFORM_DATA}
...
class OCRBackendType(str, Enum):
    ...
    RAPIDOCR = "rapidocr"
    TESSERACT = "tesseract"
    GLM_OCR = "glm_ocr"  # GLM-OCR via aether-inference (VLM-based, 0.9B params)
