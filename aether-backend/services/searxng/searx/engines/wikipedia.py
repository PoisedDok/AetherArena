...
def request(query, params):
    ...
    # Check for invalid characters that cannot be used in Wikipedia page titles
    # Wikipedia page titles cannot contain colons (used for namespaces) and other special chars
    invalid_chars = [':', '<', '>', '[', ']', '{', '}', '|', '#']
    if any(char in query for char in invalid_chars):
        # Skip this query by returning None - SearXNG will handle this gracefully
        return None
