        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1 min-w-0">
            <Popover className="relative">
              ...
              >
                <PopoverPanel className="absolute right-0 mt-2 w-64 origin-top-right rounded-2xl glass-surface border border-light-200 dark:border-dark-200 shadow-xl shadow-black/10 dark:shadow-black/30 z-50">
                  <div className="p-3">
                    <div className="mb-2">
                    ...
                    <div className="space-y-1">
                      ...
                      >
                        <FileText size={16} className="text-[#8fa9ff]" />
                        <div>
                      ...
                      >
                        <FileDown size={16} className="text-[#8fa9ff]" />
                        <div>
                          <p className="text-sm font-medium text-black dark:text-white">
                            PDF
                          </p>
