          ...
          onClick={async () => {
            ...
            const res = await fetch(`/api/videos`, {
              ...
              body: JSON.stringify({
                ...
                // Allow UI to control result count later if desired; default 9 for grid aesthetics
                numResults: 9,
              }),
            });
              ...
              slide: ({ slide }) => {
                ...
                return slide.type === 'video-slide' ? (
                  <div className="h-full w-full flex flex-row items-center justify-center">
                    <iframe
                      src={`${slide.iframe_src.replace('www.youtube.com','www.youtube-nocookie.com')}${slide.iframe_src.includes('?') ? '&' : '?'}enablejsapi=1`}
                      ref={(el) => {
                        if (el) {
