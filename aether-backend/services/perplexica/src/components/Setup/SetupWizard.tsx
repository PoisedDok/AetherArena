...
const SetupWizard = ({
  ...
  return (
    <div className="glass-surface h-screen w-screen fixed inset-0 overflow-hidden">
      <AnimatePresence>
        {showWelcome && (
          <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
            ...
            >
              ...
              >
                Welcome to{' '}
                <span className="text-[#8fa9ff] italic font-['PP_Editorial']">
                  AetherArena
                </span>
              </motion.h2>
              <motion.p
            ...
            <motion.div
              ...
              className="bg-[#8fa9ff] left-50 translate-x-[-50%] h-[250px] w-[250px] rounded-full relative z-40 blur-[100px]"
            />
          </div>
        )}
        {showSetup && (
