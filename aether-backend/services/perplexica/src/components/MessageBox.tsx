        ...
        >
          ...
          {isLast &&
            ...
            !section.message.responseBlocks.some(
              ...
              <div className="flex items-center gap-2 p-3 rounded-lg glass-panel border border-light-200 dark:border-dark-200">
              ...
              <>
                <Markdown
                  className={cn(
                    ...
                    'prose-a:text-[#6f86e6] dark:prose-a:text-[#8fa9ff] prose-a:no-underline hover:prose-a:text-[#8fa9ff] dark:hover:prose-a:text-[#b3c3ff] prose-a:transition-colors prose-a:duration-150',
