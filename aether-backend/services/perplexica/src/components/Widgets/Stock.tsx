...
const Stock = (props: StockWidgetProps) => {
  ...
  if (props.error) {
    return (
      <div className="rounded-lg glass-panel border border-light-200 dark:border-dark-200 p-4">
        ...
        <div className="flex items-start justify-between gap-4 pb-4 border-b border-light-200 dark:border-dark-200">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              ...
              {props.exchange && (
                <span className="px-2 py-0.5 text-xs font-medium rounded bg-white/5 dark:bg-white/5 text-black/60 dark:text-white/60">
                  {props.exchange}
                </span>
              )}
              {isMarketOpen && (
