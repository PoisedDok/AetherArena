    ...
    <div className="rounded-lg border border-light-200 dark:border-dark-200">
      <div className="p-4 space-y-4">
        <div className="space-y-2">
          ...
          <div className="rounded-lg border border-light-200 dark:border-dark-200 glass-panel p-3">
        ...
        <div className="space-y-2">
          ...
          <div className="rounded-xl border border-light-200 dark:border-dark-200 glass-panel p-5">
