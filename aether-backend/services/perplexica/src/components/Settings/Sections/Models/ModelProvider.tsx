...
const ModelProvider = ({
  ...
  return (
    <div
      ...
      className="border border-light-200 dark:border-dark-200 rounded-lg overflow-hidden glass-surface"
    >
              ...
              <div className="flex flex-row flex-wrap gap-2">
                {modelProvider.chatModels.map((model, index) => (
                  <div
                    ...
                    className="flex flex-row items-center space-x-1.5 text-xs lg:text-xs text-black/70 dark:text-white/70 rounded-lg glass-panel px-3 py-1.5 border border-light-200 dark:border-dark-200"
                  >
