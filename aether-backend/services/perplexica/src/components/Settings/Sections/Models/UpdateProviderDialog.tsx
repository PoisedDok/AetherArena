  ...
  return (
    <>
      <button
        ...
        className="group p-1.5 rounded-md hover:bg-white/5 dark:hover:bg-white/5 transition-colors group"
      >
        <Pencil
          size={14}
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            >
              <DialogPanel className="w-full mx-4 lg:w-[600px] max-h-[85vh] flex flex-col border glass-surface border-light-secondary dark:border-dark-secondary rounded-lg">
