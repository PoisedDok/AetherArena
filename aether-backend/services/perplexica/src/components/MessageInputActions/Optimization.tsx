      ...
      {({ open }) => (
        <>
          ...
          <AnimatePresence>
            {open && (
              <PopoverPanel
                className="absolute bottom-full mb-2 z-10 w-64 md:w-[250px] left-0"
                static
              >
                <motion.div
                  ...
                  className="origin-bottom-left flex flex-col space-y-2 glass-panel w-full p-2 max-h-[200px] md:max-h-none overflow-y-auto rounded-lg"
                >
