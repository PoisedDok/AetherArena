      ...
      {({ open }) => (
        <>
          ...
          <AnimatePresence>
            {open && (
              <PopoverPanel
                className="absolute bottom-full mb-2 z-10 w-[230px] sm:w-[270px] md:w-[300px] left-0"
                static
              >
                <motion.div
                  ...
                  className="origin-bottom-right glass-panel max-h-[300px] sm:max-w-none w-full flex flex-col shadow-lg overflow-hidden rounded-lg"
                >
                  <div className="p-2 border-b border-light-200 dark:border-dark-200">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-3 py-2 glass-panel rounded-lg placeholder:text-xs placeholder:-translate-y-[1.5px] text-xs text-black dark:text-white placeholder:text-black/40 dark:placeholder:text-white/40 focus:outline-none border border-transparent transition duration-200"
                      />
                    </div>
                  </div>
                    ...
                    {isLoading ? (
                      ...
                      <div className="flex flex-col">
                        {filteredProviders.map((provider, providerIndex) => (
                          <div key={provider.id}>
                            <div className="px-4 py-2.5 sticky top-0 glass-surface border-b border-light-200/50 dark:border-dark-200/50">
                            ...
                            {providerIndex < filteredProviders.length - 1 && (
                              <div className="h-px glass-panel" />
                            )}
                          </div>
                        ))}
                      </div>
