...
export type SearchSources = 'web' | 'discussions' | 'academic' | 'legal' | 'news';
...
export type ClassifierOutput = {
  ...
  /** Deterministic list of sources the researcher must search. */
  intentSources: SearchSources[];
  /** LLM-optimized search queries (SEO-friendly). Falls back to raw query. */
