    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh] px-2 text-center">
          <div className="flex items-center justify-center w-12 h-12 rounded-2xl glass-panel">
            ...
            {chats.map((chat, index) => {
              ...
              return (
                <div
                  key={chat.id}
                  className={
                    'group flex flex-col gap-2 p-4 hover:bg-white/5 dark:hover:bg-white/5 transition-colors duration-200 ' +
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <Link
                      href={`/c/${chat.id}`}
                      className="flex-1 text-black dark:text-white text-base lg:text-lg font-medium leading-snug line-clamp-2 group-hover:text-[#8fa9ff] transition duration-200"
                      title={chat.title}
                    >
                      {chat.title}
                    </Link>
