...
interface ChatRequestBody {
  ...
  engines?: string[]; // Custom engines to use for this search
}
...
export const POST = async (req: Request) => {
  try {
    ...
    const searchHandler: MetaSearchAgentType =
      searchHandlers[body.focusMode] || searchHandlers['webSearch'];
    ...
    const emitter = await searchHandler.searchAndAnswer(
      ...
      body.engines, // Pass custom engines if provided
    );
