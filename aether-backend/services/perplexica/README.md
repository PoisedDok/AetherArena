...
Want to know more about its architecture and how it works? You can read it in the docs/architecture/README.md file.
...
2. Navigate to the Perplexica directory containing the project files.
...
See the docs/installation directory for more information like updating, etc.
...
For more details, check out the full documentation in docs/API/SEARCH.md.
...
Perplexica is an AI-powered search engine designed to enhance your search experience. It is constantly being improved with new features and capabilities.
