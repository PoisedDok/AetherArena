...
def get_deploy_key():
    ...
    try:
        ...
        sys.exit(
            "xlwings PRO is not shipped with AetherArena (LicenseHandler unavailable). "
            "Install PRO separately or remove use of PRO-only CLI commands."
        ) from exc
...
def release(args):
    try:
        ...
        sys.exit(
            "xlwings PRO is not shipped with AetherArena (release command unavailable). "
            "Install PRO separately or remove use of PRO-only CLI commands."
        ) from exc
