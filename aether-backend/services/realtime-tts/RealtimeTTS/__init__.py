...
__all__ = [
    ...
    "Qwen3Engine", "Qwen3Voice",
    "Qwen3MLXEngine", "Qwen3MLXVoice",
...
def _load_qwen3_engine():
    try:
        from .engines.qwen3_engine import Qwen3Engine, Qwen3Voice
    except ImportError as e:
        raise ImportError(
            "Failed to load Qwen3Engine. Install with:\n"
            "pip install qwen-tts torch soundfile numpy"
        ) from e
    globals()["Qwen3Engine"] = Qwen3Engine
    globals()["Qwen3Voice"] = Qwen3Voice
    return Qwen3Engine


def _load_qwen3_mlx_engine():
    try:
        from .engines.qwen3_mlx_engine import Qwen3MLXEngine, Qwen3MLXVoice
    except ImportError as e:
        raise ImportError(
            "Failed to load Qwen3MLXEngine. Install with:\n"
            "pip install mlx-audio"
        ) from e
    globals()["Qwen3MLXEngine"] = Qwen3MLXEngine
    globals()["Qwen3MLXVoice"] = Qwen3MLXVoice
    return Qwen3MLXEngine
...
_lazy_imports = {
    ...
    "Qwen3Engine": _load_qwen3_engine,
    "Qwen3Voice": _load_qwen3_engine,
    "Qwen3MLXEngine": _load_qwen3_mlx_engine,
    "Qwen3MLXVoice": _load_qwen3_mlx_engine,
