...
Open Interpreter provides interactive capabilities for running code locally.
...
Open Interpreter can be installed on Android devices using Termux.
...
There is **experimental** support for a safe mode (see docs/SAFE_MODE.md) to help mitigate some risks.
...
The full documentation is accessible locally in the docs directory.
...
Please see the contributing guidelines in docs/CONTRIBUTING.md for more details on how to get involved.

# Roadmap

Visit the roadmap in docs/ROADMAP.md to preview the future of Open Interpreter.
