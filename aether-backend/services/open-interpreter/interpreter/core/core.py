        ...
        try:
            for chunk in respond(self):
                ...
                if hasattr(self, "stop_event") and self.stop_event.is_set():
                    ...
                    return  # Use return instead of break to properly handle generator cleanup
            ...
            # Handle generator exit gracefully - return properly instead of re-raising
            print("Generator exit received in _respond_and_store, cleaning up properly")
            return
