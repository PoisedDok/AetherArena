...
# Lazy import html2image to avoid hard dependency on system Chrome/Chromium.
# The actual import happens only when Html2Image is first accessed.
...
def html_to_png_base64(code):
    try:
        ...
        # Fallback: return a 1x1 transparent PNG so that downstream code stays happy.
        # This avoids crashing when Chrome/Chromium is not available or html2image fails.
        TRANSPARENT_PIXEL_BASE64 = (
            "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAA"
            "AAC0lEQVR42mP8/5+hHgAFgwJ/lN6K3QAAAABJRU5ErkJggg=="
        )
        ...
        try:
            ...
            logging.warning(
                "html_to_png_base64 fallback triggered: %s", str(e)[:200]
            )
        except Exception:
