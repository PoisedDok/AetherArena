"""
Interactive session utilities for Aether-RAG applications.
...
class InteractiveSession:
    ...
    def setup_readline(self):
        ...
        # History file setup
        history_dir = Path.home() / ".aether-rag" / "history"
...
def create_cli_session(index_name: str) -> InteractiveSession:
    ...
    return InteractiveSession(
        ...
        prompt="\nYou: ",
        welcome_message="Aether-RAG Assistant ready! Type 'quit' to exit, 'help' for commands\n"
        + "=" * 40,
    )
...
def create_api_session() -> InteractiveSession:
    ...
    return InteractiveSession(
        ...
        prompt="You: ",
        welcome_message="Aether-RAG Chat started (type 'quit' to exit, 'help' for commands)\n"
        + "=" * 40,
    )
